    ...
    <>
      <div className='menu h-screen bg-yellow-50 flex flex-col justify-center items-center gap-5' >
        ...
        <div className='buttons flex justify-center items-center flex-col gap-3'>
          <Link to={"/BigShow"}><button className=' w-64 px-6 py-3 bg-yellow-500 text-white font-semibold rounded-lg shadow-md hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-yellow-500' onClick={()=>bigShow()}>It’s Trivia Time!</button></Link>
        </div>
      </div>
